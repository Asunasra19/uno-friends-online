  ...
  return (
    <div className="dialog-body">
      ...
      <button
        ...
        disabled={!canStart}
        onClick={() => canStart && onStart({ cpuCount, username, character })}
      >
        ▶ Start Game
      </button>
    </div>
...
────────────────────────────────────────────────────────────── */
function FriendsContent({ onStart }) {
    ...
    <div className="dialog-body">
      ...
      <button
        ...
        onClick={() => {
          ...
          if (ready) onStart({ tab, username, character, code: tab === 'create' ? joinCode : inputCode });
        }}
      >
...
/* ──────────────────────────────────────────────────────────────
   Main GameDialog
────────────────────────────────────────────────────────────── */
export default function GameDialog({ mode, onClose }) {
  // Close on Escape key
  useEffect(() => {
  ...
  const handleStart = (data) => {
    ...
    // TODO: navigate to game with data
  ...
  const titles = {
    ...
    friends:  { icon: '👥', label: 'Play with Friends'  },
  };
      ...
      <div className="dialog-card glass">
        ...
        <div className="dialog-scroll">
          {mode === 'computer'
            ...
            : <FriendsContent  onStart={handleStart} />
          }
        </div>
      </div>
    </div>
